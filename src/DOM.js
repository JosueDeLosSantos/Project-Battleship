...
function playerAction() {
	...
	const pi1container = document.createElement("div")
	pi1container.classList.add("pi1container")
	const emptyBox = document.createElement("div")
	emptyBox.classList.add("emptyBox")
	pi1container.appendChild(emptyBox)
	const playerIndex1 = document.createElement("table")
	playerIndex1.classList.add("playerIndex1")
	pi1container.appendChild(playerIndex1)
	...
	playerGridContainer.appendChild(pi1container)
...
function opponentAction() {
  ...
  const pi1container2 = document.createElement("div")
	pi1container2.classList.add("pi1container2")
	const emptyBox2 = document.createElement("div")
	emptyBox2.classList.add("emptyBox2")
	pi1container2.appendChild(emptyBox2)
  ...
  pi1container2.appendChild(opponentIndex1)
	...
	opponentGridContainer.appendChild(pi1container2)
...
async function pcTurn(pBoard = playerBoard, oBoard = opponentBoard) {
  ...
  bar.innerText = "PC turn, please wait!"
